...
model = GReaT(llm='EleutherAI/gpt-neo-1.3B', batch_size=32,  epochs=50,
                    my_config = {"num_layers" : 4, "attention_types": [[["global", "local"], 2]] })

begin_time = datetime.datetime.now()
model.fit(df)
end_time = datetime.datetime.now()

model_name = "gpt_neo_4_layer_stroke_healthcare"
