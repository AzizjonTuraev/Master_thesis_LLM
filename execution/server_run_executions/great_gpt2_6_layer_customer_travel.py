...
model = GReaT(llm='openai-community/gpt2', batch_size=40,  epochs=50,
        my_config={"n_layer":6})
...
sample_time.to_csv(f"samples/process_time/process_time_model_name_1.csv")
...
sample_time = pd.DataFrame([sample_time])
sample_time.to_csv(f"samples/process_time/process_time_model_name_2.csv")
...
sample_time = pd.DataFrame([sample_time])
sample_time.to_csv(f"samples/process_time/process_time_model_name_3.csv")
...
sample_time = pd.DataFrame([sample_time])
sample_time.to_csv(f"samples/process_time/process_time_model_name_4.csv")
...
sample_time = pd.DataFrame([sample_time])
sample_time.to_csv(f"samples/process_time/process_time_model_name_5.csv")
