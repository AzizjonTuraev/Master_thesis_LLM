...
import datetime
from transformers.models.gpt_bigcode import GPTBigCodeConfig, GPTBigCodeForCausalLM
import os
...
rtf_model = REaLTabFormer(
    generic_Config = GPTBigCodeConfig,
    generic_LMHeadModel = GPTBigCodeForCausalLM,
...
model_name = "gpt_bigcode_12_layer_stroke_healthcare"
